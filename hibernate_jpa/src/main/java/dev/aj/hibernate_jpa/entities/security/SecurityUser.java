...
import dev.aj.hibernate_jpa.entities.AuditMetaData;
...
public class SecurityUser implements UserDetails {
    ...
    @Id
    @GeneratedValue(strategy = jakarta.persistence.GenerationType.SEQUENCE, generator = "security_user_seq_generator")
