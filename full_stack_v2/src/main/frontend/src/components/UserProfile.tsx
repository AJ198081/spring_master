...
export const UserProfile = () => {
    ...
    useEffect(() => {
        ...
        const fetch2FAStatus = async () => {
            try {
                const response = await AxiosInstance.get(`/auth/user/2fa-status`);
    ...
    const verify2FA = async () => {
        ...
        try {
            ...
            await AxiosInstance.post(`/auth/verify-2fa`, formData, {
                headers: {
    ...
    const handleUpdateCredential = async (data) => {
        ...
        try {
            ...
            await AxiosInstance.post("/auth/update-credentials", formData, {
                headers: {
                    "Content-Type": "application/x-www-form-urlencoded",
                },
            });
    ...
    const handleAccountExpiryStatus = async (event) => {
        ...
        try {
            ...
            await AxiosInstance.put("/auth/update-expiry-status", formData, {
                headers: {
                    "Content-Type": "application/x-www-form-urlencoded",
                },
            });
    ...
    const handleAccountLockStatus = async (event) => {
        ...
        try {
            ...
            await AxiosInstance.put("/auth/update-lock-status", formData, {
                headers: {
                    "Content-Type": "application/x-www-form-urlencoded",
                },
            });
    ...
    const handleAccountEnabledStatus = async (event) => {
        ...
        try {
            ...
            await AxiosInstance.put("/auth/update-enabled-status", formData, {
                headers: {
                    "Content-Type": "application/x-www-form-urlencoded",
                },
            });
    ...
    const handleCredentialExpiredStatus = async (event) => {
        ...
        try {
            ...
            await AxiosInstance.put("/auth/update-credentials-expiry-status", formData, {
                headers: {
                    "Content-Type": "application/x-www-form-urlencoded",
                },
            });
