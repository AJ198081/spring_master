...
export const NoteDetails = () => {
    ...
    const checkAdminRole = async () => {
        try {
            const response = await AxiosInstance.get("/auth/user"); // Adjust the endpoint as necessary to get user info
    ...
    const fetchAuditLogs = useCallback(async () => {
        try {
            const response = await AxiosInstance.get(`/audit/note/${id}`);
