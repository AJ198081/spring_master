...
public class CORSOverride implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/api/**")
                .allowedOrigins(getFrontendHost())
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOrigins(List.of(getFrontendHost()));
    ...
    private String getFrontendHost() {
        return environment.getProperty("frontend.app.host");
    }
}
