...
public class ProductController {
    ...
    public ResponseEntity<ProductResponseDto> patchProduct(@PathVariable Long productId, @RequestBody ProductRequestDto productRequestDto) {
        return ResponseEntity.ok(productService.patchProduct(productId, productRequestDto));
    }
}
